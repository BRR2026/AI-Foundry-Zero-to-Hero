# Week 4: Hands-On Lab — Responsible AI in Azure AI Foundry
...
- ✅ An Azure AI Foundry project created (from Week 2/3)
...
> 💡 **Note**: If you haven't completed the previous weeks' labs, you'll need to create an AI Foundry project and deploy a model before proceeding. Refer to Week 2 and 3 lab guides.
...
Next week's lab will focus on **Prompt Engineering Fundamentals**. The Responsible AI principles you've learned this week will directly inform how you design safe, effective prompts. Keep your content filter configurations — you'll use them to test how well-crafted prompts work within safety guardrails.
