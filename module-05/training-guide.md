# Module 5: Setting Up Your Environment + First "Hello World" Model

## **ARC 1: Foundations** | Module 5 of 45 — Zero to Hero: Azure AI Foundry
...
- **Completed Modules 1–4** of this training course (foundational understanding of AI Foundry).
...
> 💡 **Tip:** This is the most hands-on module so far! Modules 1–4 built your theoretical foundation — now it's time to get your hands dirty with real code and real AI models. Set aside 3–4 uninterrupted hours.
...
Congratulations! You've made it through four modules of foundational learning. You understand what AI Foundry is, how Azure's AI ecosystem works, the technology stack behind modern AI, and the architecture that ties it all together. Now it's time for the exciting part: **building something real**.
...
Module 5: Your first programmatic AI interaction
"""
import os
...
Module 5: Your first chatbot application
...
def main():
    ...
    print()
    print("╔══════════════════════════════════════════════════════╗")
    print("║  🤖 AI Foundry Chatbot — Module 5                      ║")
...
|----------|-----------------|------------------------------|
| this module's labs | ~10,000 | ~$0.005 |
| A full module of development | ~100,000 | ~$0.05 |
| Building a chatbot prototype | ~1,000,000 | ~$0.50 |
| All 45 Modules (estimate) | ~5,000,000 | ~$2.50 |
...
### What You Accomplished this module 🎉
...
### Looking Ahead: Module 6 — Prompt Engineering Deep Dive

next module we'll master the art and science of writing effective prompts:
...
> 💡 **Tip:** Practice using your chatbot this module! The more you interact with the model, the better you'll understand how prompts affect responses — which is exactly what Module 6 is all about.
