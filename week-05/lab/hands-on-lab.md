...
| Weeks 1–4 completed | Familiarity with AI Foundry portal concepts from prior labs |
...
> **🎯 Goal:** Install all the tools you need for the rest of this 45-week course. This is a one-time setup that pays dividends for every future lab.
...
> **🎉 Congratulations!** Your development environment is ready. This setup will serve you for the remaining 40 weeks of the course.
...
def main():
    ...
    print()
    print("╔══════════════════════════════════════════════════════╗")
    print("║  🤖 AI Foundry Chatbot — Week 5 Lab                 ║")
    print("║                                                      ║")
...
For students who want to go further before next week:
