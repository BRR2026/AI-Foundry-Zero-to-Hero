# Week 1: What is AI Foundry?

## **ARC 1: Foundations** | Week 1 of 45 — Zero to Hero: Azure AI Foundry
...
> 💡 **Tip:** You do *not* need an Azure subscription to follow along with this week's material. We'll set one up together in Week 2.
...
Let's walk through the six major capabilities of Azure AI Foundry. Don't worry about mastering these now — we'll dive deep into each one in later weeks.
...
> 💡 **Tip:** Prompt engineering is one of the most valuable skills in AI today. We'll dedicate an entire week to it later in the course.
...
> ⚠️ **Important:** Responsible AI isn't optional — it's a core part of building with AI Foundry. Microsoft provides these tools because deploying AI without safety measures can cause real harm. We'll cover this extensively in ARC 6 (Weeks 26–30).
...
> 📝 **Note:** You can browse the portal and explore the Model Catalog without an Azure subscription. To create projects and deploy models, you'll need one — we'll set that up in Week 2.
...
> 💡 **Tip:** Don't worry if you don't understand everything on the model cards yet. The goal is just to get comfortable navigating the portal. We'll explain all the technical details in coming weeks.

---

## 9. Summary & Key Takeaways

Let's recap what we covered this week:
...
## 10. Preview of Week 2

### 📅 Week 2: Understanding the AI Lifecycle

Next week, we'll explore the **end-to-end journey** of building an AI application:
...
> 🚀 **Get ready!** Week 2 is where we go from *understanding* to *doing*. Make sure you have a Microsoft account ready.
...
```
✅ WEEK 1  — What is AI Foundry? (YOU ARE HERE)
   WEEK 2  — Understanding the AI Lifecycle
   WEEK 3  — Azure Fundamentals for AI
   WEEK 4  — AI Foundry Architecture Deep Dive
   WEEK 5  — Your First AI Project (End-to-End)
   ─────────────────────────────────────────────
...
> 🎉 **Congratulations!** You've completed Week 1 of your Zero to Hero journey. You now know what Azure AI Foundry is, why it matters, and what it can do. Next week, we roll up our sleeves and start building. See you there!
