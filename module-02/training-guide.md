...
- **Completed Module 1:** You should understand what Azure AI Foundry is and its key capabilities.
...
> 💡 **Tip:** this module bridges *understanding* and *doing*. We'll explain the full AI lifecycle conceptually, then you'll set up your Azure environment and take your first hands-on steps in AI Foundry.
...
In Module 1, we learned that Azure AI Foundry is a unified platform — a "factory" for building AI applications. But every factory needs a *process*. Cars don't appear on the showroom floor by magic — they go through design, engineering, assembly, quality control, and delivery.
...
This journey is called the **AI Development Lifecycle**, and understanding it is the single most important foundation for everything you'll learn in this 45-Module course.
...
Let's extend Module 1's factory analogy:
...
> 💡 **Tip:** For most beginner projects, simply uploading files to Azure Blob Storage and creating an Azure AI Search index is the easiest path. We'll practice this in later modules.
...
> 📝 **Note:** Most enterprise AI applications use **RAG** (Retrieval-Augmented Generation), which means connecting a pre-built model to your company's documents. You don't need to retrain the model — you just give it access to your data at query time. We'll cover RAG in depth in later modules.
...
│  │              │    │                  │    │                  │       │
│  │ ⏱️ Minutes   │    │ ⏱️ Hours-Days    │    │ ⏱️ modules-Months  │       │
...
| **Time to implement** | Minutes to hours | Hours to days | modules to months |
...
Starting this module, we'll be doing hands-on work in Azure AI Foundry. To follow along, you need:
...
Detailed instructions are in the **Hands-On Lab** for this module, but here's the overview:
...
## 13. Connecting the Dots — From Module 1 to Module 3

### What We've Built So Far

```
Module 1: WHAT is AI Foundry?        Module 2: HOW does AI work?
┌──────────────────────────┐       ┌──────────────────────────┐
...
In Module 3, we'll move from theory to practice with **"Navigating the AI Foundry Portal."** You'll:
...
> **next module:** [Module 3 — Navigating the AI Foundry Portal →](../module-03/training-guide.md)
>
> **Previous module:** [← Module 1 — What is AI Foundry?](../module-01/training-guide.md)
