# Week 2: Hands-On Lab — Understanding the AI Lifecycle
...
If you plan to continue with Week 3's lab, **keep everything running**. The costs will be negligible.
...
In **Week 3**, we'll take a deeper dive into the AI Foundry portal, exploring every section in detail and building on the project you just created.
