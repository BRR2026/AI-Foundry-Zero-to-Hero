# Week 3: AI Foundry Architecture & Components
...
Welcome to Week 3! In the first two weeks, you got oriented with Azure AI and set up your first environment. Now we pull back the curtain and examine **how AI Foundry is actually built** — the resource hierarchy, the networking, the identity model, and the deployment options that determine how your AI solutions behave in production.
...
**Next Week:** [Week 4 — Working with Models in AI Foundry →](../week-04/training-guide.md)

**Previous Week:** [← Week 2 — Setting Up Your Environment](../week-02/training-guide.md)
