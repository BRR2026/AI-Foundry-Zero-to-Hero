# Week 3 Hands-On Lab: Exploring AI Foundry Architecture & Components
...
- [x] An AI Foundry Hub and at least one Project (created in Week 2)
...
blob = container_client.download_blob("week-03/sample-data.txt")
...
**Next Lab:** [Week 4 — Working with Models in AI Foundry →](../../week-04/lab/hands-on-lab.md)
